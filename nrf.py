...
def sendPayload(data):
    ...
    resp = spi.xfer2([0b10100000, 0x02] + baseaddr + [0x68, 0x34, 0x78, 0x24] + data + [0x02] + baseaddr + [0x68, 0x34, 0x78, 0x24] + data)
...
# Write RX_ADDR
spi.xfer2([0x20 | 0x0A, 0x7A, 0x56, 0x34, 0x12, 0x00])
...
while True:
	...
	time.sleep(1)
	print "Sending back: " + printpayload([0xff, 0xff, 0xff] + payload)
